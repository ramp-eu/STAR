...
class RobotPost(object):
    ...
    def ProgStart(self, progname):
        ...
        self.addline('pName, ' + progname)
        self.addline('pStart')
        
        
    def ProgFinish(self, progname):
        self.addline('pFinish')
    ...
    def MoveJ(self, pose, joints, conf_RLF=None):
        ...
        self.addline('PTP,%s' % (joints_2_str(joints)))
        
    def MoveL(self, pose, joints, conf_RLF=None):
        """Add a linear movement"""
        self.addline('Line,%s' % (joints_2_str(joints)))
        
    def MoveC(self, pose1, joints1, pose2, joints2, conf_RLF_1=None, conf_RLF_2=None):
        """Add a circular movement"""    
        self.addline('Move Circular (1),%s,%s' % (pose_2_str(pose1), joints_2_str(joints1)))
        self.addline('Move Circular (2),%s,%s' % (pose_2_str(pose2), joints_2_str(joints2)))
